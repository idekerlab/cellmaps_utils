...
class ProvenanceUtil(object):
    """
    Wrapper around fairscape calls
    """
    def __init__(self, fairscape_binary='fairscape-cli'):
        """
        Constructor

        :param fairscape_binary: Fairscape cli command line binary
    ...
    def register_computation(self, rocrate_path, name='',
        ...
        :param used_software: list of FAIRSCAPE software ids
        :type used_software: list
        :param used_dataset: list of FAIRSCAPE dataset ids used
                             by this computation
        :type used_dataset: list
        :param generated: list of FAIRSCAPE dataset ids for datasets
    ...
    def register_software(self, rocrate_path, name='unknown', description='',
        ...
        :return: guid of software from FAIRSCAPE
        :rtype: str
        """
    ...
    def add_dataset_to_rocrate(self, rocrate_path, data_dict=None,
        ...
        :return: id of dataset from FAIRSCAPE
        :rtype: str
        """
